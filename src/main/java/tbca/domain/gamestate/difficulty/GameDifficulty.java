...
import static tbca.domain.combatant.enemy.EnemyType.GOBLIN;
import static tbca.domain.combatant.enemy.EnemyType.WOLF;
import static tbca.domain.item.ItemType.POTION;
